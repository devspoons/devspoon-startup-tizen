...
repo --name=local --baseurl=file:///root/GBS-ROOT/local/repos/unified_standard/armv7l/ --priority=1

repo --name=unified-standard --baseurl=http://download.tizen.org/snapshots/tizen/unified/latest/repos/standard/packages/repodata/ --ssl_verify=no
...
elm-sharp-theme-common
libHarfBuzzSharp
libSkiaSharp
org.tizen.autofill-setting-mobile
# @ IoT Adaptation RPI3
alsa-utils
...
building-blocks-sub2-Preset_boards-RPI3-Audio_Recording
building-blocks-sub2-Preset_boards-RPI3-BLE
building-blocks-sub2-Preset_boards-RPI3-Bluetooth
building-blocks-sub2-Preset_boards-RPI3-Bluetooth_CallAudio
building-blocks-sub2-Preset_boards-RPI3-Camera
building-blocks-sub2-Preset_boards-RPI3-Codec
building-blocks-sub2-Preset_boards-RPI3-DALi
building-blocks-sub2-Preset_boards-RPI3-Display
building-blocks-sub2-Preset_boards-RPI3-EFL
building-blocks-sub2-Preset_boards-RPI3-IM
building-blocks-sub2-Preset_boards-RPI3-Sensor
building-blocks-sub2-Preset_boards-RPI3-System
building-blocks-sub2-Preset_boards-RPI3-System_Device
building-blocks-sub2-Preset_boards-RPI3-WifiDirect
...
sed -ri \
	-e 's|@BUILD_ID[@]|tizen-unified_20191031.1|g' \
...
if [ -n "$IMG_NAME" ]; then
	...
	echo "$IMG_NAME tizen-unified_20191031.1" >>$INSTALL_ROOT/etc/tizen-snapshot
fi
